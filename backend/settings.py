...
SECRET_KEY = 'django-insecure-8q4t9rc=@xn=u1g4!cre=tly=sespg%d%d@kk_rhb(@_y3yaav'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [' memko.pythonanywhere.com','gpmonde.com', 'localhost', '127.0.0.1']
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                 # Permet le renouvellement du token de rafraîchissement
